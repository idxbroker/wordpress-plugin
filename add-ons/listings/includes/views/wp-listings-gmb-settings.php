...
if ( empty( $google_my_business_options['refresh_token'] ) ) {
	wp_enqueue_style( 'impress-gmb-login', WP_LISTINGS_URL . 'includes/css/impress-gmb-login.css', [], '1.0.0' );
	wp_enqueue_script( 'impress-gmb-login', WP_LISTINGS_URL . 'includes/js/impress-gmb-login.js', [], '1.0.0', true );
	wp_localize_script(
		'impress-gmb-login',
		'impressGmbAdmin',
		[
