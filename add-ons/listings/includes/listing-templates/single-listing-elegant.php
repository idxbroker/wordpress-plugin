...
function enqueue_single_listing_scripts() {
	...
	wp_enqueue_style( 'impb-google-fonts-elegant' );
	wp_enqueue_style( 'impb-elegant-template', IMPRESS_IDX_URL . 'assets/css/listing-templates/single-listing-elegant.min.css', [], '1.0' );
	// Template Scripts.
	wp_enqueue_script( 'fitvids' );
	wp_enqueue_script( 'jquery-validate' );
	wp_enqueue_script( 'wp-listings-single' );
	wp_enqueue_script( 'impb-elegant-script', IMPRESS_IDX_URL . 'assets/js/listing-templates/single-listing-elegant.min.js', [], '1.0', false );
	// Dequeue any known conflicting styles.
	...
	<div class="entry-content wplistings-single-listing listing-template">
		...
		<div id="listing-tabs" class="listing-data">
			...
			<div id="listing-details">
				...
				if ( ! empty( get_the_term_list( get_the_ID(), 'features', '<li>', '</li><li>', '</li>' ) ) ) {
