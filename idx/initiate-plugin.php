 ...
 */
    ...
    public function add_menu()
    {
        ...
        $api_errors = $this->idx_api->idx_api_get_systemlinks()->errors;
        $api_systemlinks = $this->idx_api->idx_api_get_systemlinks();
        if (!isset($api_errors) && !empty($api_systemlinks)) {
