...
class Register_Impress_Shortcodes {
	...
	/**
	 * The lead_login_shortcode function.
	 *
	 * @access public
	 * @param mixed $atts contains the attributs for the lead_login_shortcode function.
	 * @return html $widget contains the html markup for the widget generated by the shortcode.
	 */
	...
	/**
	 * The lead_signup_shortcode function.
	 *
	 * @since 2.5.10
	 * @access public
	 */
	...
	/**
	 * The property_showcase_shortcode function.
	 *
	 * @since 2.5.10
	 * @access public
	 * @param array $atts (default: array()).
	 * @return html $output of the generated html for the shortcode.
	 */
	public function property_showcase_shortcode( $atts = array() ) {
		...
		foreach ( $properties as $prop ) {
			...
			if ( 1 === $use_rows && 1 !== $count ) {
				...
				if ( 0 === $count % $num_per_row || $total === $count || $max === $count ) {
	 ...
	 *
	 * @since 2.5.10
	 * @param  mixed $field contains the field data.
	 * @param  text  $display_name contains the display name of the field.
	 * @param  mixed $value contains the value of the field data.
	 * @return html  markup for the output for the field.
	 */
	...
	/**
	 * The set_missing_core_fields function.
	 *
	 * @since 2.5.10
	 * @access public
	 * @param mixed $prop contains property information.
	 * @return array $prop array containing the property information.
	 */
	 ...
	 * @since 2.5.10
	 * @access public
	 * @param mixed $new_window markup for the target value for the links.
	 * @return text for the target value.
	 */
	...
	/**
	 * The property_carousel_shortcode function.
	 *
	 * @since 2.5.10
	 * @access public
	 * @param array $atts (default: array()).
	 * @return html $output html markup for the widget.
	 */
	...
	/**
	 * The city_links_shortcode function.
	 *
	 * @since 2.5.10
	 * @access public
	 * @param array $atts (default: array()).
	 * @return html $city_links markup for the list of city links.
	 */
