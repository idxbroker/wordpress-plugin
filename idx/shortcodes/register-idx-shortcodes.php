...
/**
 * Begin defining the Register_Idx_Shortcodes class.
 *
 * @since 2.5.10
 */
class Register_Idx_Shortcodes {
	/**
	 * Begin defining the __construct function.
	 *
	 * @since 2.5.10
	 */
	...
	/**
	 * Begin including the idx_api class.
	 *
	 * @since 2.5.10
	 * @var class $idx_api
	 */
	 ...
	 *
	 * @since 2.5.10
	 * @param array $atts contains the arguments for the widget.
	...
	public function show_widget( $atts ) {
		...
		if ( ! is_null( $id ) ) {
			...
			if ( strpos( $url, 'mapwidgetjs.php' ) ) {
				...
				// Recommend using the enqueue method whenever the map widget type is used.
	 ...
	 *
	 * @since 2.5.10
	 * @param array $atts contains the attributes for the show_system_link function.
	 ...
	 *
	 * @param array $atts contains the attributes for the show_link function.
	 * @since 2.5.10
	 ...
	 *
	 * @param array $atts contains the attributes for the show_saved_link funciton.
	 * @since 2.5.10
	 * @return string|boolean
	 */
	...
	/**
	 * The idx_get_link_by_uid function is used to fetch the IDX Broker system links and saved links by their unique id numbers.
	 *
	 * @since 2.5.10
	 * @param int $uid contains the unique id number of the link.
	 * @param int $type contains the assigned type value of the type of link.
	 * @return text $selected_link
	 */
	...
	/**
	 * The function wrapper_tags defines the unique div tags used by the IDX Broker wrapper system.
	 *
	 * @since 2.5.10
	 * @return html containing the div tags used to create the IDX Broker wrapper tags.
	 */
