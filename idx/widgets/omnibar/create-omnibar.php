...
EOD;
    ...
    <form class="idx-omnibar-form idx-omnibar-extra-form">
      <input class="idx-omnibar-input idx-omnibar-extra-input" type="text" placeholder="$placeholder" onblur="if (this.value == '') {this.value = '$placeholder';}" onfocus="if (this.value == '$placeholder') {this.value = '';}">
