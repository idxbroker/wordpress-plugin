...
import { IdxBlock, IdxButton, IdxCard, IdxCardBody, IdxCardHeader, IdxList, IdxListItem, IdxTabContainer } from '@idxbrokerllc/idxstrap'
...
const components = [IdxBlock, IdxButton, IdxCard, IdxCardBody, IdxCardHeader, IdxList, IdxListItem, IdxTabContainer]
