...
import { IdxBlock, IdxButton, IdxCard, IdxCardBody, IdxCardHeader, IdxContainer, IdxFullscreen, IdxList, IdxListItem } from '@idxbrokerllc/idxstrap'
...
const components = [IdxBlock, IdxButton, IdxCard, IdxCardBody, IdxCardHeader, IdxContainer, IdxFullscreen, IdxList, IdxListItem]
