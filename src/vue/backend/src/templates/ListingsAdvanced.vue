<template>
    <idx-block tag="fieldset" className="listings-advanced form-content">
        ...
        <hr/>
        <idx-form-group>
            <idx-block className="control-label"><idx-block tag="strong" className="control-label-title">Form Submissions to IDX Broker</idx-block> Send all contact form submissions to IDX Broker as a lead.<br> <b>Note:</b> This option only works while using default contact forms.</idx-block>
        </idx-form-group>
        <idx-form-group>
            <idx-block className="form-content__toggle">
                {{ sendFormLabel }}
        ...
        <idx-form-group>
            <idx-block className="control-label"><idx-block tag="strong" className="control-label-title">Default Form Shortcode</idx-block> Detailed sentence or two describing short code compatibility with Contact Form plugin. If no short code is entered the template uses default contact forms.</idx-block>
        </idx-form-group>
        <idx-form-group>
        ...
        <hr/>
        <idx-form-group>
            <idx-block className="control-label"><idx-block tag="strong" className="control-label-title">Custom Wrapper</idx-block> Detailed sentence or two describing how custom wrappers can be used and how to set them up properly.</idx-block>
        </idx-form-group>
        <idx-form-group>
        ...
        <hr/>
        <idx-form-group>
            <idx-block className="control-label"><idx-block tag="strong" className="control-label-title">Plugin Uninstallation</idx-block> Checking this option will delete <b>all</b> plugin data when uninstalling the plugin.</idx-block>
        </idx-form-group>
        <idx-form-group>
            <idx-block className="form-content__toggle">
