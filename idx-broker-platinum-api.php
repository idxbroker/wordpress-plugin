...
function idx_platinum_get_systemlinks()
{
    ...
    $response = $request->request('https://api.idxbroker.com/clients/systemlinks', array('timeout' => 120, 'sslverify' => false, 'headers' => $headers));
...
function idx_platinum_get_savedlinks()
{
    ...
    $response = $request->request('https://api.idxbroker.com/clients/savedlinks', array('timeout' => 120, 'sslverify' => false, 'headers' => $headers));
    $response = (array)$response;
