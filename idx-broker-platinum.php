...
function idx_broker_platinum_options_init() {
	...
	wp_enqueue_script('idxjs', plugins_url('idx-broker-platinum-plugin/idxbroker.js'), 'jquery');
	wp_enqueue_style('idxcss', plugins_url('idx-broker-platinum-plugin/css/idxbroker.css'));
	...
	?>
		<div id="idxPluginWrap" class="wrap">
			...
			<div style="display: table; width: 87%;">
				<h2 class="flft">IDX Broker Platinum&reg; Plugin (Beta) Settings</h2>
				<br clear="all"/>
			</div>	
			...
			<form method="post" action="options.php" id="idx_broker_options">
				...
				<ul id="genSettings">
					<li>
                       ...
                       <input type="button" name="api_update" id="api_update" value="Refresh Plugin Options" class="button-primary" style="width:153px;" />
						...
						<br />
						If you do not have an IDX Broker account, please contact the IDX Broker team at 800-421-9668.</label>
				...
				</h3><ul id="widgSettings"><li>
				IDX Widgets give you a way to promote your Featured Listings, Agents, and any Custom Links. In addition, you have access to Quick Search forms, a Lead Login widget, and several more powerful Widgets. If you have created additional Widgets in IDX Broker, simply click the "Refresh Plugin Information" button in Step 1 and then visit your <a href="widgets.php">Widgets Tab</a> in WordPress to drag-and-drop IDX Widgets into your sidebar. <br /><br />Take me to my <a href="widgets.php">Widgets Tab</a> now.</li></ul>
				<h3>
					<label>Step 3: Add IDX System Navigation Links</label>
					
				</h3>
				<p>Most IDX Broker subscribers add Basic Search, Map Search, Advanced Search, Featured Listings, and a Roster Page to their site navigation. Note that the IDX Broker plugin will add these pages automatically when you check the corresponding box below. You may then create a <a href="nav-menus.php">Custom Menu</a> using these pages, or reorder the display of these pages using your <a href="edit.php?post_type=page">Pages Tab</a> in WordPress.
				<br class="clear" />
				<?php 
			...
			<br />	Check the box next to the page link you wish to add to your navigation. To remove an IDX page, simply uncheck the box next to the page you wish to remove and click the "Update System Links" button.</p>
				...
				<div>
					...
					<br />
					To create your saved links, login to IDX Broker and go to <a href="http://middleware.idxbroker.com/mgmt/savedlinks.php" target="_blank">Saved Links.</a> Once you have built and saved your saved links, revisit this page and hit the refresh button. Your new links will automatically appear below. Simply choose the custom links that you wish to display in your theme header navigation and IDX Broker will add those pages and link to the corresponding IDX results.</p>
				</div>
			<?php 
			} else {
    	?>
