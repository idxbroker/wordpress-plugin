...
<div id="idxPluginWrap" class="wrap">
	...
	<form method="post" action="options.php" id="idx_broker_options">
			...
			<div id="widgSettings">
				...
				<p>Widgets give you a way to add Quick Search, Featured Listings, Agents, and Custom Links to your WordPress pages. IDX Broker Platinum comes with a default set of Widgets. If you have created additional, custom Widgets, simply click the "Refresh Plugin Options" button in Step 1 and visit your <a href="widgets.php">Widgets Tab</a> in WordPress to drag-and-drop IDX Widgets into your sidebar.</p>
			</div>
			<div id="widgSettings">
				<h3>
			...
			<div>
				<p>You do not have any system links because you may have entered an incorrect API key. Please review Step 1.</p>
			...
			?>	
							<li>
								<input type="checkbox" name="idx_platinum_system_<?php echo $system_link->uid;?>" id="idx_platinum_system_<?php echo $system_link->uid;?>" <?php echo $std_check_options; ?> class="systemLink idx_platinum_sl" />
	...
	<div id="dynamic_page">
		<h3>Setp 5: Create a Dynamic Wrapper Page</h3>
		...
		<div id="dynamic_page_url" style="display: none;">
			<span class="label">Page Line:</span>
			<a href="<?php echo $wrapper_page_url; ?>" target="_blank"><?php echo $post_title; ?></a>
		</div>
	</div>
	<hr>
